                    ...
                    <li class="col-md-4" style="margin-bottom:30px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                            <a href="<?php echo base_url(); ?>user/viewprofile/<?php echo $sto['user_id']; ?>"><?php echo $sto['user_name']." ".$sto['user_lastname']; ?></a>
                            </div>
                    ...
                    <?php else: ?>  
                        <br />
                        <span style="font-size:16px;color:#888;">No following users found.</span>
                        <br /><br />
                    <?php endif; ?>
