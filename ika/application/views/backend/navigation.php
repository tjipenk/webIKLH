...
<nav class="navbar navbar-findcond" style="position:fixed;top:0;left:0;right:0;z-index:1000">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url(); ?>input/dashboard">Akuisisi Data IKLH</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>input/daftar_sungai">Daftar Lokasi Sungai</a></li> 
               <li><a href="<?php echo base_url(); ?>input/data_sungai">Data Pemantauan</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>input/daftar_sungai">Daftar Lokasi</a></li> 
               <li><a href="<?php echo base_url(); ?>input/data_sungai">Data Pemantauan</a></li>
          </ul>
        </li>
          ...
          <li class="hide"><a href="<?php echo base_url(); ?>input/options">Pengaturan</a></li>    
	 </ul>
      ...
      <ul class="nav navbar-nav navbar-right ">
        <li class="dropdown hide"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                        <a href="<?php echo base_url(); ?>input/editstory/<?php echo $rep['posts_id']; ?>"><span class="label label-warning">Report content</span><br /><span title="<?php echo $rep['desc']; ?>"><?php echo substr($rep['desc'], 0, 50)."..."; ?></span><br />
