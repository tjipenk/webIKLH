                                    ...
                                    <div class="">
                                        <div class="form-group no-border">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <a href="<?php echo site_url('admin/data_udara'); ?>">
...
$.ajax({
url: "<?php echo site_url('admin/add_data_udaradata'); ?>",
type: 'POST',
async : false,
data: $('#editdata').serialize(),
success: function(msg) {
if (msg = "edit") { window.location.replace("<?php echo site_url('admin/data_udara'); ?>"); }
}
});
return false;
});
