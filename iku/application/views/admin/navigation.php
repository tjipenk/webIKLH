      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
               ...
               <li><a href="<?php echo base_url(); ?>admin/data_udara">Data Pemantauan</a></li>
               <li class="dropdown ">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pemantauan Udara<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url(); ?>admin/data_udara/2016">2016</a></li>
                    </ul>
                </li>
          </ul>
        </li>
        ...
        <li class="dropdown ">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pemantauan Udara<span class="caret"></span></a>
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>admin/daftar_udara">Daftar Lokasi</a></li> 
               <li><a href="<?php echo base_url(); ?>admin/data_udara">Data Pemantauan</a></li>
          </ul>
        </li>
