      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>input/daftar_udara">Daftar Lokasi Udara</a></li> 
               <li><a href="<?php echo base_url(); ?>input/data_udara">Data Pemantauan</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown ">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pemantauan Udara<span class="caret"></span></a>
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>input/daftar_udara">Daftar Lokasi</a></li> 
               <li><a href="<?php echo base_url(); ?>input/data_udara">Data Pemantauan</a></li>
          </ul>
        </li>
