										...
										<?php if (count($sungai)>0): ?>
                                            <?php foreach($sungai as $pub): ?>
                                                <tr data-id="<?php echo $pub['id_udara']; ?>">
													...
													?>
                                                            <td class="">
																<a style="cursor:pointer;" class="removerutilizador" onclick="reject(<?=$pub['id_udara']?>)">
																	<span class="label label-danger">Tolak</span>
																</a> | 
																<a style="cursor:pointer;" class="editstory" onclick="validate(<?=$pub['id_udara']?>)">
																	<span class="label label-warning">Validasi</span>
																</a>
															</td>
