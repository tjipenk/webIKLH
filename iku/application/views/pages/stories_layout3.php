...
.item{
  ...
  <!-- Wrapper for slides -->
    ...
    <div class="col-md-12 hidden-sd hidden-xs" style="margin-bottom: 20px;margin-top:-10px;background:rgba(0,0,0,0.7);">
   

	<div class="container" style="padding:20px 20px">
	 <h2 style="color:#fff">Forum diskusi Simfoni</h2>
	 <p style="color:#fff;font-size:16px;margin-top:10px">
	 Forum diskusi merupakan media komunikasi untuk berbagi bagi kelompok tani dan pemerintah.
	 </p>
    ...
    <div class="col-md-12 hidden-md hidden-lg" style="margin-bottom: 20px;margin-top:-20px;background:rgba(0,0,0,0.7);">
...
jQuery(document).ready(function($){
    ...
    jQuery('.storiesloadarea').each(function(i){
        ...
        $('#more_button_masonry').unbind('click').bind('click',function(e){e.preventDefault();
                ...
                $.post("<?php echo base_url(); ?>forum/loadStories_layouts/"+loaded_messages+"/"+<?php echo $layout; ?>, { search: search, filtera: filtera, filterb: filterb,category: category,tag: tag,qtd: qtd,<?php echo $this->security->get_csrf_token_name(); ?>: '<?php echo $this->security->get_csrf_hash(); ?>'},
                function(data){
