                    ...
                    <?php 
                    if (($com == 1) && ($numposts < 9)) { 
                        $trendingposts = $this->stories_model->get_trending_posts();
                    ?>

                        <li class="article col-md-4 col-sm-6" style="position:relative;min-height:0;opacity:0;padding: 0px 5px;">
                             <div class="blocks" style="border: 1px solid #ecf0f1;box-shadow: 0 1px 6px rgba(0,0,0,0.04);">
                                <div style="padding:20px;">
                                <span style="color:#FFF;padding:0px 5px;" class="catf pull-left">TRENDING</span>
                                </div>


                                <ul class="trendingposts">
                    ...
                    <li class="col-sm-12 col-md-12">
                        <div class="row">
                            <section class="vote col-sm-2 col-md-2"><?php echo $num; ?></section>
                            <article class="story-title col-sm-10 col-md-10" style="padding-left:20px;">
                                <h2>
                                    <a href="<?php echo base_url(); ?>stories/article/<?php echo $tre['post_slug']; ?>"><?php if (strlen($tre['post_subject']) > 45) { echo mb_substr($tre['post_subject'],0,45)."..."; } else { echo utf8_encode($tre['post_subject']); } ?></a>
                                </h2> 
                                <time datetime="2015-11-28 14:15:35" style="font-size: 11px;color: #CCC;"><i class="fa fa-clock-o"></i>&nbsp;<?php echo $this->stories_model->calculartempo($tre['post_date'], date("Y-m-d H:i:s")); ?></time>
                            </article>
                        </div>
                    </li>
                    <?php $num++; endforeach; ?>
                    ...
                    <li class="article col-md-4 col-sm-6" style="position:relative;min-height:0;opacity:0;padding: 0px 5px;">
                       ...
                       <section class="story-vote">
                        ...
                        <article class="story-title col-sm-12 col-md-12">
                          ...
                          <p style="margin:0;margin-bottom:10px;"><?php echo strip_tags(mb_substr($sto['post_text'],0,100)).'...'; ?></p>
                          <?php } ?>
...
/*jQuery(window).load(function() {
    ...
    jQuery('.storiesloadarea').each(function(i){
        ...
        // Infinite
        $currentItem.find('#more_button_masonry').unbind('click').bind('click',function(e){e.preventDefault();
            loadStories();
