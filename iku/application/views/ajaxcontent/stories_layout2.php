...
$i = 0; if (count($stories)>0): $com = 0; ?>                 
<?php foreach($stories as $sto): ?>

                   
<?php if (($com == 4) && ($this->option_model->get_value('appadscodehome'))) { ?>
    <li class="article advertising col-md-6 col-sm-6" style="position:relative;min-height:0;opacity:0;padding: 0px 5px;">
        <div class="blocks" style=""><?php echo $this->option_model->get_value('appadscodehome');  ?></div>
    </li>
<?php } ?>
...
?>
                    ...
                    <li class="article col-md-6 col-sm-6" style="position:relative;min-height:0;opacity:0;padding: 0px 5px;">
					...
					?>
                     ...
                     <li class="article col-md-6 col-sm-6 hidden-lg hidden-xl" style="position:relative;min-height:0;opacity:0;padding: 0px">
                       <div class="blocks" style="">
                       <div class="row"> 
                        ...
                        <article class="story-title col-sm-12 col-md-12">
                          ...
                          <div class="meta">
                            ...
                            <div class="dropdown socialdropdown" style="display: none;z-index:9999;">
                              <button class="socialshare dropdown-toggle" type="button" data-toggle="dropdown"><span class="txt">Bagikan</span>
...
if($i >3) {?>
                    <!-- post -->
                    <li class="article col-md-6 col-sm-6 hidden-xs  hidden-sm hidden-md" style="position:relative;min-height:0;opacity:0;padding: 0px 20px 10px 0">
                       <div class="blocks" style="">
                       <div class="row"> 
                        <div class="col-sm-12 col-md-12">
