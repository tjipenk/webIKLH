...
$.ajax({
url: "<?php echo site_url('admin_prov/sungaieditdata'); ?>",
type: 'POST',
async : false,
data: $('#editdata').serialize(),
success: function(msg) {
	// alert(msg);
if (msg = "edit") { alert("Data Berhasil Di Update.");window.location.replace("<?php echo site_url('admin_prov/daftar_udara'); ?>"); }
}
});
return false;
});
