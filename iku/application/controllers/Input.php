...
private $user_id = "";
	function __construct(){
		parent::__construct();
		$this->load->model('input_model', 'admin_model');
	...
	//	redirect('/admin/dashboard', 'location');
		redirect('/input/daftar_udara', 'location');
	...
	public function dashboard()
    {
        ...
        $this->load->view('input/dashboard_ika', $data);
	...
	public function users()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/users', $data);
        $this->load->view('layout/footer');
	}
	...
	public function register()
	{
        ...
        $this->load->view('layout/header');
		$this->load->view('layout/navigation_prov', $sel);
		$this->load->view('input/register', $data);
		$this->load->view('layout/footer');
	}
	...
	function edit_user($id){
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
	    $this->load->view('input/edit_user', $data);
	    $this->load->view('layout/footer');	
	}
	...
	public function daftar_udara(){
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/daftar_udara', $data);
        $this->load->view('layout/footer');
	}
	...
	public function load_udara(){
		...
		$this->load->view('input/load_udara', $data);
	}
	...
	function add_udara() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/add_udara',$data);
        $this->load->view('layout/footer');
	}
	...
	public function data_udara(){
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/data_udara',$data);
        $this->load->view('layout/footer');
	}
	...
	public function load_data_udara(){
		...
		$this->load->view('input/load_DataUdara', $data);
	}
	...
	function add_data_udara() {
		...
		*/
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/add_data_udara',$data);
        $this->load->view('layout/footer');
	}
