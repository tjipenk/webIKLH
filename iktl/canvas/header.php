...
<html lang="en">
	<head>
		...
		<!-- stylesheets -->
		<link href="http://localhost/simfoni/canvas/assets/bootstrap.min.css" rel="stylesheet">
		<link href="http://localhost/simfoni/canvas/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet">
		<link href="http://localhost/simfoni/canvas/assets/style.css" rel="stylesheet">
		
		<!-- scripts -->
		<script src="http://localhost/simfoni/canvas/assets/js/jquery-3.1.0.min.js"></script>
		<script src="http://localhost/simfoni/canvas/assets/js/bootstrap.min.js"></script>
