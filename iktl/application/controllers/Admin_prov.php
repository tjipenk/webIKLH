...
private $user_id = "";
	...
	{
		parent::__construct();
		$this->load->model('adminprov_model','admin_model');
	...
	public function loadusers()
	{
		...
		$this->load->view('admin_prov/ajaxcontent/loadUsers', $data);
	}
/*
	...
	function adduser() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/useradd');
        $this->load->view('layout/footer');
	}
*/
	...
	public function daftar_tutupan()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/daftar_tutupan',$data);
        $this->load->view('layout/footer');
	}
	...
	function add_tutupan() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/add_tutupan');
		$this->load->view('layout/footer');
	}
	...
	function edittutupan($i) {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/edit_tutupan', $data);
        $this->load->view('layout/footer');
	}
	...
	public function load_sungai()
	{
		...
		// $this->load->view('admin_prov/ajaxcontent/loadSungai', $data);
	...
	public function load_data_sungai()
	{
		...
		// $this->load->view('admin_prov/ajaxcontent/loadDataSungai', $data);
	...
	public function parameter_sungai()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/daftar_par_sungai');
        $this->load->view('layout/footer');
	}
	...
	public function load_par_sungai()
	{
		...
		// $this->load->view('admin_prov/ajaxcontent/loadParSungai', $data);
		$this->load->view('admin_prov/load_ParSungai', $data);
	}
	...
	function add_par_sungai() {
		...
		*/
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/add_par_sungai',$data);
        $this->load->view('layout/footer');
	}
	...
	function add_kelompok_tani() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/add_kelompok_tani',$data);
        $this->load->view('layout/footer');
	}
	...
	function edituser($i) {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/useredit', $data);
        $this->load->view('layout/footer');
	}
	...
	public function stories()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/stories');
        $this->load->view('layout/footer');
	}
	...
	function editstory($i) {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/storyedit', $data);
        $this->load->view('layout/footer');
	}
	...
	public function loadstories()
	{
		...
		$this->load->view('admin_prov/ajaxcontent/loadStories', $data);
	}
	...
	function tambah_sungai() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/add_kelompok_tani');
        $this->load->view('layout/footer');
	}
	...
	/* public function tambah_sungai_proses() 
	{
		...
		$this->load->view('admin_prov/header');
        $this->load->view('admin_prov/navigation', $sel);
        $this->load->view('admin_prov/tambah_berhasil',$yeay);
        $this->load->view('admin_prov/footer');
	}
	*/
	...
	$data['categories'] =$this->stories_model->kategori("1");
		$this->load->view('admin_prov/ajaxcontent/loadCategories', $data);
	}
...
public function remove_pengumuman($id)
	...
	function addcategory() {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/categoriesadd');
        $this->load->view('layout/footer');
	}
	...
	function editcategory($i) {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/categoriesedit', $data);
        $this->load->view('layout/footer');
	}
	...
	public function pages()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/pages');
        $this->load->view('layout/footer');
	}
	public function loadpages()
	{
		...
		$this->load->view('admin_prov/ajaxcontent/loadPages', $data);
	}
	...
	function editpage($i) {
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/pageedit', $data);
        $this->load->view('layout/footer');
	}
	function addpage() {
		$sel['sel'] = "pages";
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/pageadd');
        $this->load->view('layout/footer');
	}
	...
	public function comments()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/comments');
        $this->load->view('layout/footer');
	}
	public function loadcomments()
	{
		...
		$this->load->view('admin_prov/ajaxcontent/loadComments', $data);
	}
	...
	public function options()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/options', $data);
        $this->load->view('layout/footer');
	}
	...
	public function Tampilan()
	{
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('admin_prov/tampilan', $data);
        $this->load->view('layout/footer');
	}
