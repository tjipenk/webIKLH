...
<h1 class="page_title_text">Data Indeks Konservasi Badan Air</h1>
	...
	<div class="row content">
			...
			<table class="table datatable table-striped" id="datatable">
                                        <thead>
                                            <tr>
                                                <th>Kabupaten</th>
                                                <th>Hutan Sempadan Sungi</th>
                                                <th>Luas Sempadan Sungi</th>
                                                <th>IKBA</th>
                                        ...
                                        <tbody>
                                                ...
                                                <?php if (count($sungai)>0): ?>
                                                        ...
                                                        <tr data-id="<?php echo $pub['id_wilayah']; ?>">
                                                            ...
                                                            <td><?php echo round($pub['areaFRS'],2);?></td>																											
                                                            <td><?php echo round($pub['areaBuff'],2);?></td>																																																						
