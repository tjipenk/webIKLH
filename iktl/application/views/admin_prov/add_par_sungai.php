...
<h1 class="page_title_text">Tambah Parameter Pengamatan Sungai</h1>
</div>
</div>
                                    ...
                                    <div class="">
                                        <div class="form-group no-border">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <a href="<?php echo site_url('admin/parameter_sungai'); ?>">
...
$.ajax({
url: "<?php echo site_url('admin/add_par_sungai_data'); ?>",
type: 'POST',
async : false,
data: $('#editdata').serialize(),
success: function(msg) {
if (msg = "edit") { window.location.replace("<?php echo site_url('admin/parameter_sungai'); ?>"); }
}
});
return false;
});
