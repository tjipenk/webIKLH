...
<div class="container" id="pagecontent">
                            ...
                            <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-sm-4"> 
                                        ...
                                        <?php if (($this->session->userdata('logged_in') == TRUE) && ($this->session->userdata('userid') != $use['user_id'])) { ?>
                                            ...
                                            <a class="btnfollow" data-id="<?php echo $use['user_id']; ?>" href="javascript:void(0);">Following</a>
                                            <?php } else { ?>
                                            <a class="btnfollow" data-id="<?php echo $use['user_id']; ?>" href="javascript:void(0);">Follow</a>
                                            <?php } ?>
                                        <?php } ?>                                        
                                    </div>
                            </div>
    ...
    <ul class="nav nav-tabs tabs-up" id="profiletabs">
      <li class="active"><a href="<?php echo base_url();?>stories/get_posts/<?php echo $id; ?>" data-target="#recentstories" class="media_node active span" id="contacts_tab" data-toggle="tabajax" rel="tooltip">Recent Posts <span><?php echo $num_recentposts; ?></span></a></li>
      <li><a href="<?php echo base_url();?>stories/followers/<?php echo $id; ?>" data-target="#followers" class="media_node span" id="friends_list_tab" data-toggle="tabajax" rel="tooltip">Followers <span><?php echo $num_followers; ?></span></a></li>
      <li><a href="<?php echo base_url();?>stories/following/<?php echo $id; ?>" data-target="#following" class="media_node span" id="awaiting_request_tab" data-toggle="tabajax" rel="tooltip">Following <span><?php echo $num_following; ?></span></a></li>
      <li><a href="<?php echo base_url();?>stories/favourites/<?php echo $id; ?>" data-target="#favourites" class="media_node span" id="favourites_tab" data-toggle="tabajax" rel="tooltip">Favourites <span><?php echo $num_favourites; ?></span></a></li>
    </ul>
...
jQuery(document).ready(function(){
    ...
    loadPosts  = function() 
    {
        $.post('<?php echo base_url();?>stories/get_posts/<?php echo $id; ?>',
           {
