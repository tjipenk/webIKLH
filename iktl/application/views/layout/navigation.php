...
<nav class="navbar navbar-findcond" style="position:fixed;top:0;left:0;right:0;z-index:1000">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url(); ?>admin/dashboard">Aplikasi Perhitungan Indeks KTL</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">

        <li class="dropdown ">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Data Tutupan Lahan<span class="caret"></span></a>
