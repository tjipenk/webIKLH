...
private $user_id = "";
	...
	public function load_sungai(){
		...
		$this->load->view('input/load_Sungai', $data);
	}
	...
	public function data_sungai(){
		...
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/data_sungai',$data);
        $this->load->view('layout/footer');
	}
	...
	public function load_data_sungai(){
		...
		$this->load->view('input/load_DataSungai', $data);
	}
	...
	function add_data_sungai() {
		...
		*/
		$this->load->view('layout/header');
        $this->load->view('layout/navigation_prov', $sel);
        $this->load->view('input/add_data_sungai',$data);
        $this->load->view('layout/footer');
	}
