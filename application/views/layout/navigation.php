...
<nav class="navbar navbar-findcond" style="position:fixed;top:0;left:0;right:0;z-index:1000">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url(); ?>admin/dashboard">Aplikasi Perhitungan IKLH</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown ">
          ...
          <ul class="dropdown-menu">
               <li><a href="<?php echo base_url(); ?>admin/dashboard">Dashboard IKLH Nasional</a></li> 
               ...
               <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url(); ?>admin/rekap_iklh/<?php echo date("Y",strtotime("-2 year"));?>"><?php echo date("Y",strtotime("-2 year"));?></a></li>
                    <li><a href="<?php echo base_url(); ?>admin/rekap_iklh/<?php echo date("Y",strtotime("-1 year"));?>"><?php echo date("Y",strtotime("-1 year"));?></a></li>
                    <li><a href="<?php echo base_url(); ?>admin/rekap_iklh/<?php echo date('Y');?>"><?php echo date('Y');?></a></li>
                    </ul>
                </li>
               </ul>
        </li>
