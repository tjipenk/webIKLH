...
<h1 class="page_title_text">Parametar Pemantauan Sungai</h1>
</div>
<a href="<?php echo site_url('admin/add_par_sungai'); ?>" style="float:right;">
	<br />
...
<div class="pull-right hidden-xl hidden-lg" style="margin-top: 20px">
				<a href="<?php echo site_url('admin/add_par_sungai'); ?>" id="tambah"style="background: #80b500;color: #fff;padding: 15px 20px 15px 0px;margin:20px 0 0 0;border-radius:30px;position:fixed;bottom:20px;right:30px"><i class="glyph-icon flaticon-add"></i></a>
				</div>
...
$("#usersform").on('submit',(function(e) {
        e.preventDefault();
                ...
                $.post("<?php echo base_url(); ?>admin/load_par_sungai", {
                p:p,
