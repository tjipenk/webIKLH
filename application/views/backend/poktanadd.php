...
<div class="pull-left ">
<h1 class="page_title_text hidden-xs">Kelompok tani</h1>
</div>
</div>
                    ...
                    <div class="col-md-12" style="padding: 0px">
                        ...
                        <div class="panel panel-default" style="border: 0px!important;padding: 0px!important">
                            ...
                            <div class="panel-body">
                                    ...
                                    <?php echo form_open_multipart("gapoktan/tambah_gapoktan", array("method"=>"POST","id"=>'editdata','class'=>'form-horizontal form-bordered'));?>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pola1" class="form-control" value="">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pola2" class="form-control" value="">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pola3" class="form-control" value="">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
